...
object BookDao {
  ...
  def insertBook (authorFirst: String, authorLast : String, title: String) : Unit = {
      val conn = ConnectionUtil.getConnection()
      try {
      var authorId: Int = -1;
  ...
  def updateAuthor (firstName : String, lastName : String, changedFirstName : String, changedLastName : String) : Unit = {
      val conn = ConnectionUtil.getConnection()
